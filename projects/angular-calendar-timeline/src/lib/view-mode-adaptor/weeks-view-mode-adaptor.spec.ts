...
describe('WeeksViewModeAdaptor', () => {
  let handler: WeeksViewModeAdaptor;

  beforeEach(() => {
    handler = new WeeksViewModeAdaptor();
  });
  ...
  it('Count of unique weeks between 06.06.2021 and 01.07.2021 should be 4', () => {
    ...
    const countOfDays = handler.getUniqueColumnsWithinRange(firstDate, secondDate);
  ...
  it('Count of unique weeks between 15.12.2021 and 16.12.2021 should be 1', () => {
    ...
    const countOfWeeks = handler.getUniqueColumnsWithinRange(firstDate, secondDate);
  ...
  it('Time duration in weeks between 14.12.2021 and 21.12.2021 should be 1', () => {
    ...
    const countOfWeeks = handler.getDurationInColumns(firstDate, secondDate);
    expect(countOfWeeks).toEqual(1);
  });
});
